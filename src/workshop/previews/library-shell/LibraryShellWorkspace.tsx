...
const checks = [
  ...
  'Global strip: Section, Home, Library, Discover, Profile. Section opens only the current page’s destinations.',
  'Main Library states exercise Home, Library, Discover, Sects and Tiers. Back/Forward updates the active destination.',
  'Cave Section contains Home, Stories and Relics; public Section also has Exit. Settings stays beneath Daily Dao Pillar.',
...
export function LibraryShellWorkspace() {
  ...
  return <FeatureWorkspace entry={workshopEntries.find(entry => entry.id === 'library-shell')!}
    ...
    workshopControls={{ description: 'Shared Library navigation: top header, global destinations and contextual Section menus. Existing Story Seed and Reader navigation remain specialized.', sections: [{ id: 'pages', content: <div className="flex flex-wrap gap-4">
