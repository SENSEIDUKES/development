...
export const ownershipRules = [
  ...
  ['src/components/reader-chamber/shared/alterFateLock.ts', 'workshop', 'locked-reference adapter'],
  ['src/components/reader-codex/shared/codexHighlighting.ts', 'workshop', 'locked-reference adapter'],
  ['src/components/reader-codex/shared/codexCompatibility.ts', 'workshop', 'locked-reference adapter'],
  ['src/components/reader-codex/shared/agents.ts', 'workshop', 'locked-reference adapter'],
  ['src/components/reader-codex/shared/hubStories.ts', 'workshop', 'locked-reference adapter'],
  ['src/components/reader-codex/shared/CodexHovercard.tsx', 'workshop', 'locked-reference adapter'],
  ['src/components/library-shell/capture-manifest.json', 'workshop', 'capture provenance'],
  ['src/package/sen/package.json', 'tooling', 'distribution manifest'],
  ['src/package/library/package.json', 'tooling', 'distribution manifest'],
  ['src/components/story-seed/shared/referenceIntake.ts', 'workshop', 'locked-reference adapter'],
  ['src/components/story-seed/shared/dialect.ts', 'workshop', 'locked-reference adapter'],
  ['src/components/chapter-manifestation/shared/loadingVeil.ts', 'workshop', 'locked-reference adapter'],
