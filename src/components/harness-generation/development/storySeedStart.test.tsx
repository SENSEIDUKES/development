...
import { type HarnessGenerationModelAdapter, type HarnessSkillManifest, type HarnessStorySeedSource } from '@seihouse/sen/harness-generation';
...
describe('Harness Story Seed entry', () => {
  ...
  it('shows understandable per-story slots and the actual equipped state', async () => {
    ...
    expect(container.textContent).not.toContain('MediaEmpty');
    expect(container.querySelector('#harness-skill-media')).toBeNull();
