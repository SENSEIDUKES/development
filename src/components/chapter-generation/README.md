...
`system` object and System Panels. Inline World Cues remain a Reader-owned
annotation boundary for Phase 3; the model is not asked to emit cue payloads,
Codex IDs, media IDs, storage keys, or image URLs.
...
- **2026-08-19:** Removed the retired standalone world-presentation payload, parser, prompt direction, effect kind, fixtures, and tests. Generation still emits visual Codex metadata and structured System/Fate content; automatic inline World Cue integration remains deferred to Phase 3.
