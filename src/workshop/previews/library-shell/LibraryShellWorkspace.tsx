...
export function LibraryShellWorkspace() {
  ...
  return <FeatureWorkspace entry={workshopEntries.find(entry => entry.id === 'library-shell')!}
    ...
    workshopControls={{ description: 'One shared top header across Library pages. Test the optional slot, original Help experience, Search, responsive sizing and keyboard navigation.', sections: [{ id: 'pages', content: <div className="flex flex-wrap gap-4">
