...
import type { SystemEventKind, SystemPromptBadge, SystemPromptChange, SystemPromptPresentation, SystemStatusAbility, SystemStatusBar, SystemStatusEffect, SystemStatusScreen, SystemStatusStat, WorldNoticeDetail, WorldNoticeEntry, WorldNoticeData, BaseSystemEvent, RegularSystemEvent, FateSystemEvent, SystemEvent as ChapterSystemEvent } from './chapter';
...
export interface ChapterDiagnostics {
  ...
  generationPosition?: import('../components/arc-goals/shared/arcGoals').ArcChapterPosition;
...
export interface StoryArc {
  goalContext?: import('../components/arc-goals/shared/arcGoals').ArcGenerationContext;
  persistenceId?: string;
  title: string;
  chapters: Chapter[];
  isCompleted: boolean;
...
export interface ReaderPreferences {
   ...
   */
  readingLanguage?: import('../components/reader-chamber/shared/readerLanguage').ReaderLanguageChoice;
...
export interface BaseCodexEntry {
  ...
  manifestationImportance?: import('../components/reader-chamber/shared/manifestationEligibility').ManifestationImportance;
...
export interface StoryWorld {
  ...
  readingAnchor?: import('../components/reader-chamber/shared/cinematicScroll/anchors').ReadingAnchor;
  readingStats?: {
