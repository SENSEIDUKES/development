...
- **2026-08-24:** Matched the `CodexHovercard` Manifest seal to the refined Codex Card emblem: the dragon loop turns counterclockwise around the fixed glass core, and the shared `LibraryDragonCycleIcon` carries its redrawn silhouette (tapered curved tail, cleaner head, subtler back spines). Aura, mask, core content, and the manifestation flow are unchanged.
