import { createEmptyHarnessWorkspaceState, readHarnessWorkspaceState, HARNESS_GENERATION_SCHEMA_VERSION, type HarnessWorkspaceState, type HarnessGenerationRepository } from '@seihouse/sen/harness-generation';
