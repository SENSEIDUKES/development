...
/** The Seed's power-system fields; the Seed workspace and Blueprint review share them. */
export const PowerSystemFields = ({ seed, updateSeed }: PowerSystemWorkspaceProps) => {
