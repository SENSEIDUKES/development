...
import { Character, Faction, Artifact, Location } from '@seihouse/sen/contracts';
import { useReaderStore } from '@seihouse/sen/reader-runtime';
import { getColorCodeStyle, resolveCodexEntityColorCode } from '@seihouse/sen/color-codes';
