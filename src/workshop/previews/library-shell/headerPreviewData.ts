...
export const headerStates = {
  ...
  'main-library': ['linked', 'create', 'library', 'discover', 'sects', 'tiers', 'reader', 'guest', 'syncing', 'offline', 'profile', 'active-story', 'long-name', 'missing-profile', 'dao-local', 'dao-error'],
