...
{"id": "c1-p2", "type": "dialogue", "text": "\\"Who dares disturb my slumber?\\" Overseer Chen bellowed.", "metadata": {"mode": "dialogue", "speakerName": "Overseer Chen", "speakerRole": "villain", "emotion": "cruel", "intensity": 0.85, "tension": 0.9, "entities": [{"name": "Overseer Chen", "type": "character", "mention": "reveal"}]}}
{"id": "c1-p3", "type": "paragraph", "text": "Suddenly, the sky tore open. The Thunder Roc emerged, completely blotting out the moon.", "metadata": {"mode": "narration", "tension": 0.9, "entities": [{"name": "Thunder Roc", "type": "creature", "mention": "reveal"}], "beastEvent": {"type": "reveal", "profile": {"size": "giant", "bodyType": "bird", "element": "lightning", "movement": "flying", "intelligence": "ancient", "threatTier": "mythic", "signatureSound": "screech"}}}}
