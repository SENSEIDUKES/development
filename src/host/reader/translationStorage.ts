import { READER_TRANSLATION_SCHEMA_VERSION, readerTranslationKey, type DerivedChapterTranslation, type ReaderTranslationRepository, type ReaderTranslationSkillReference } from '@seihouse/sen/translation';
